...
export class Traveler {
    ...
    public static travelTo(creep: Creep, destination: IPosition, options: TravelToOptions = {}): number {
    ...
    public static normalizePos(destination: IPosition): RoomPosition {
    ...
    public static findTravelPath(origin: IPosition, destination: IPosition,
    ...
    public static findPathDistance(origin: IPosition, destination: IPosition,
